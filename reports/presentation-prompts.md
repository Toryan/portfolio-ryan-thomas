...
-   I jittered the outliers and made them translucent so that they can all be seen. (Robbins, [2013](#ref-Robbins:2013a))
...
-   I ordered the data by the outliers on the deficiet side, going from lowest to highest. This makes it easier to pick out discrepencies between the categories. (Knaflic, [2013](#ref-Knaflic:2013-09))
...
State the number of observations: 528
...
-   type: Categorical, nominal
-   levels (if categorical): 22

variable name: Time of day

-   type: Categorical, ordinal
-   levels (if categorical): 24
...
-   There are 11 columns and 2 rows to make the slopes closer 45 degrees and make it easier to see trends \[@?\]
...
-   I changed the x label from RPM to thousand RPM so they woulden't write over each other. -There are 9 columns in one row to make the slopes closer 45 degrees and make it easier to see trends \[@?\]
