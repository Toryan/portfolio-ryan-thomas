...
- I jittered th outliers and made them translucent so that they can all be seen. [@Robbins:2013a]
...
- I used a cubic scale to serve the same purpose as a log scale, but It also works for negative numbers [@Wainer:2014]
...
- I chose to have 5 columns and 5 rows because more than 5 becomes overly difficult to read [@Doumont:2009]
